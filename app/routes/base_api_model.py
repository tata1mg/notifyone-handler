...
class OperatorDetails:
    name = openapi.String(
        description="Operator/Gateway name used to send the email", example="<Operator>"
    )
    event_id = openapi.String(
        descritpion="Operator event id for this request", example="12121212121212"
    )
